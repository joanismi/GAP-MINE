...
genePANDA_fs <- oplsda.fs(genePANDA, reactome_labels)
write.csv(as.data.frame(genePANDA_fs[,1]),"../python/data/processed/fs/reactome_genePANDA_fs_string.csv", row.names = FALSE)
write.csv(as.data.frame(genePANDA_fs[,2]),"../python/data/processed/fs/reactome_genePANDA_test_string.csv", row.names = FALSE)

maxlink_fs <- oplsda.fs(maxlink, reactome_labels)
write.csv(as.data.frame(maxlink_fs[,1]),"../python/data/processed/fs/reactome_maxlink_fs_string.csv", row.names = FALSE)
write.csv(as.data.frame(maxlink_fs[,2]),"../python/data/processed/fs/reactome_maxlink_test_string.csv", row.names = FALSE)
...
disease_genePANDA_fs <- oplsda.fs(disease_genePANDA, disgenet_labels)
write.csv(as.data.frame(disease_genePANDA_fs[,1]),"../python/data/processed/fs/disease/disease_genePANDA_fs_string.csv", row.names = FALSE)
write.csv(as.data.frame(disease_genePANDA_fs[,2]),"../python/data/processed/fs/disease/disease_genePANDA_test_string.csv", row.names = FALSE)

disease_maxlink_fs <- oplsda.fs(disease_maxlink, disgenet_labels)
write.csv(as.data.frame(disease_maxlink_fs[,1]),"../python/data/processed/fs/disease/disease_maxlink_fs_string.csv", row.names = FALSE)
write.csv(as.data.frame(disease_maxlink_fs[,2]),"../python/data/processed/fs/disease/disease_maxlink_test_string.csv", row.names = FALSE)
...
disease_genePANDA_fs_conservative <- oplsda.fs(disease_genePANDA_conservative, disgenet_labels_conservative)
write.csv(as.data.frame(disease_genePANDA_fs_conservative[,1]),"../python/data/processed/fs/disease/disease_genePANDA_fs_conservative_string.csv", row.names = FALSE)
write.csv(as.data.frame(disease_genePANDA_fs_conservative[,2]),"../python/data/processed/fs/disease/disease_genePANDA_test_conservative_string.csv", row.names = FALSE)
