...
disease_conservative_raw_scores <- matrix(0,length(disease_modules[['process']]) , length(V(ppi_graph)$name))
rownames(disease_conservative_raw_scores) <- disease_modules[['process']]
